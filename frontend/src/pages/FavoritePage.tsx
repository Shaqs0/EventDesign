...
import { CalendarIcon, LocationIcon, star_fill_dark, StarNFill, start_filled, StartFill } from '../assets';
...
export function FavoritePage() {
	...
	return (
		<div className="flex min-h-[80vh] w-full dark:text-[black]">
				...
				{activeEvent ? (
					<>
						<div className="flex w-[88%] items-center justify-between">
							...
							<img
								src={activeEvent.favorite === 1 ? isLightTheme ?  start_filled :StartFill : StarNFill}
						...
						<div className="flex w-full items-center justify-start p-10 px-20">
							<div className="w-full justify-start rounded-lg p-4">
								<div className="flex w-full items-center space-x-2 border-b border-[white] border-opacity-[10%] pb-4 dark:border-[#000000]">
								...
								<div className="mt-10 flex w-full items-center space-x-2 border-b border-[white] border-opacity-[10%] pb-4 dark:border-[#000000]">
								...
								<div className="mt-10">
									<div className="mt-2 h-[30vh] w-full rounded-lg bg-primary-grey p-2 text-[white] dark:bg-[#ffffff] dark:text-[black]" style={{ wordBreak: 'break-word' }}>
